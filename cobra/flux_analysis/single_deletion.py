    ...
    for the_gene in gene_list:
        ...
        if mutant_model._trimmed:
            ...
            if not the_problem:
                the_problem = wt_problem
            #reset the model
            mutant_model._trimmed = False
            mutant_model._trimmed_genes = []
            [(setattr(k, 'lower_bound', v[0]),
              setattr(k, 'upper_bound', v[1]))
             for k, v in mutant_model._trimmed_reactions.items()]
            mutant_model._trimmed_reactions = {}
