...
class Group(Object):
    ...
    kind : string
        ...
        short, members of a "classification" group should have an "is-a" relationship
        to the group (e.g. member is-a polar compound, or member is-a
        transporter). Members of a "partonomy" group should have a "part-of"
        relationship (e.g. member is part-of glycolysis). Members of a
    ...
    def __init__(self, id=None, name='', members=None, kind=''):
    ...
    def add_members(self,members_to_add):
        ...
        for member in members_to_add:
            ...
            if not member.id in _id_to_members:
