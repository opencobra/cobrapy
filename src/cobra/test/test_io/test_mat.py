...
"""
The wrong model is generated by
import scipy.io as scipy_io
from cobra.io.mat import load_matlab_model, create_mat_dict, save_matlab_model
from cobra.io import load_json_model, read_sbml_model

mini_model_cobra = read_sbml_model("cobrapy/src/cobra/test/data/mini_cobra.xml")
save_matlab_model(mini_model_cobra, "cobrapy/src/cobra/test/data/mini.mat")
mat_dict = create_mat_dict(mini_model_cobra)
...
new_fields = [
    ...
    "metCASNumber".upper(),
    "rxnECNumbers".upper(),
    "rxnMetaNetXID".casefold(),
    "rxnKeggID",
    "rxnRHEAID",
    "rxnBIOCycID",
    "rxnBIGGID",
]
for _old, _new in zip(old_fields, new_fields):
    mat_dict[_new] = mat_dict.pop(_old)
scipy_io.savemat(
    "cobrapy/src/cobra/test/data/mini_wrong_key_caps.mat",
