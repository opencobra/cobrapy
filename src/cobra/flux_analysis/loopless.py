...
def loopless_solution(
    ...
    When providing fluxes to the method also note that those have to come the model
    provided, meaning that no bounds or coefficients have been changed and the
