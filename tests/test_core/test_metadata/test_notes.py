...
def test_notes(data_directory, tmp_path):
    ...
    model_path = data_directory / "e_coli_core_for_annotation.xml"
...
def test_reading_writing_notes(data_directory, tmp_path):
    ...
    model = read_sbml_model(data_directory / "e_coli_core_for_annotation.xml")
    ...
    path_to_json = tmp_path / "json_notes.json"
